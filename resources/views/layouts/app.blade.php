                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-auto row align-self-center text-md-start text-center">
                            <div class="d-inline-flex col-auto justify-content-center">
                                <a class="d-flex text-decoration-none text-white social-footer-link" href="https://discord.gg/y5bSGsPEcP">
                                    <i class="fab fa-2x fa-discord mr-1"></i>
                                </a>
                            </div>
                            <div class="d-inline-flex col-auto justify-content-center">
                                <a class="d-flex text-decoration-none text-white social-footer-link" href="https://twitter.com/CrapishRevival">
                                    <i class="fab fa-2x fa-twitter mr-1"></i>
                                </a>
                            </div>
                            <div class="d-inline-flex col-auto justify-content-center">
                                <a class="d-flex text-decoration-none text-white social-footer-link" href="https://twitch.tv/CrapishCommunity">
                                    <i class="fab fa-2x fa-twitch mr-1"></i>
                                </a>
                            </div>
                            <div class="d-inline-flex col-auto justify-content-center">
                                <a class="d-flex text-decoration-none text-white social-footer-link text-white social-footer-link" href="https://github.com/Crapish-Community">
