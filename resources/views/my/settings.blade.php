    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-preferences" role="tabpanel" aria-labelledby="pills-preferences-tab">
            <div class="container px-0">
                <div class="card card-body">
                    ...
                    <small class="text-muted pb-2">Old corescripts are temp disabled</small>
                    <form method="post">
                        @csrf
                        ...
                        <div class="form-check">
                            <input class="form-check-input" value="new_cores" type="radio" name="old_cores" id="themeRadio" disabled="disabled">
        ...
        <div class="tab-pane fade" id="pills-theme" role="tabpanel" aria-labelledby="pills-theme-tab">
            <div class="container px-0">
                <div class="card card-body">
                    <h3>Site Theme</h2>
                    <small class="text-muted pb-2">Yes, Lumen is back</small>
                    <form method="post">
                        @csrf
