...
Route::get('/moderator/ban', [App\Http\Controllers\ModeratorController::class, 'banlist'])->name('moderator.ban');
...
Route::get('/Game/LuaWebService/HandleSocialRequest.ashx', [App\Http\Controllers\ClientController::class, 'luawebservice'])->name('client.luawebservice');
...
Route::any('/game/players/{id}', [App\Http\Controllers\ClientController::class, 'getChatFilter']);
Route::get('/ownership/hasasset/{assetid}/{userid}', [App\Http\Controllers\ClientController::class, 'getAssetOwnership']);
Route::any('/moderation/filtertext', [App\Http\Controllers\ClientController::class, 'getFilteredText']);
