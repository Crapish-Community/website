...
class ClientController extends Controller
{
    ...
    public function charapp_asset(Request $request)
    {
        ...
        foreach ($wearingItems as $wearingItem) {
            ...
            if ($item) {
                if ($item->isXmlAsset()) {
                    $appearance[] = 'http://' . request()->getHost() . '/asset?id=' . $wearingItem->item_id;
                } else {
        ...
        foreach ($wearingItems as $wearingItem) {
            ...
            if ($item) {
                if ($item->isXmlAsset()) {
                    ...
                    $appearance[] = 'http://' . request()->getHost() . '/xmlasset?id=' . $wearingItem->item_id;
                }
            }
        }
    ...
    public function luawebservice(Request $request)
    {
       $response = Response::make('false');
       return $response;
    }
