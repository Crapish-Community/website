									...
									<a class="text-decoration-none" href="{{ route('users.profile', $server->creator) }}">
										<div class="position-relative text-center h-100">
											...
											@if (\App\Models\User::find($server->creator)->verified_hoster)
												<div data-toggle="tooltip" data-placement="left" title="Verified Hoster" style="right: 0; bottom: 0;" class="badge badge-primary text-white shadow-sm badge-pill user-select-none ml-1"><i class="fas fa-badge-check"></i></div>
											@endif
										</div>
