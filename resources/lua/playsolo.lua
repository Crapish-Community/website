...
function ifSeleniumThenSetCookie(key, value)
    ...
    pcall(function() game:GetService("InsertService"):SetFreeModelUrl("http://www.crapish.fun/Game/Tools/InsertAsset.ashx?type=fm&q=%s&pg=%d&rs=%d") end) -- Used for free model search (insert tool)
    pcall(function() game:GetService("InsertService"):SetFreeDecalUrl("http://www.crapish.fun/Game/Tools/InsertAsset.ashx?type=fd&q=%s&pg=%d&rs=%d") end) -- Used for free decal search (insert tool)
    ...
    game:GetService("InsertService"):SetUserSetsUrl("http://www.crapish.fun/Game/Tools/InsertAsset.ashx?nsets=20&type=user&userid=%d")
    ...
    pcall(function() game:GetService("GamePassService"):SetPlayerHasPassUrl("http://www.crapish.fun/Game/GamePass/GamePassHandler.ashx?Action=HasPass&UserID=%d&PassID=%d") end)
    ...
    pcall(function() game:GetService("Players"):SetBuildUserPermissionsUrl("http://www.crapish.fun//Game/BuildActionPermissionCheck.ashx?assetId=0&userId=%d&isSolo=true") end)
    ...
    player.CharacterAppearance = "http://www.crapish.fun/Asset/CharacterFetch.ashx?userId=1&placeId=0"
    ...
    visit:SetPing("http://www.crapish.fun/Game/ClientPresence.ashx?version=old&PlaceID=0", 120)
    ...
    if not inStudio then
    if false then
    game:HttpPost("http://www.crapish.fun/Error/Lua.ashx?", "Visit.lua: " .. err)
    end
    end
    end